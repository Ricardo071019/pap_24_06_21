...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Jun-2021 às 14:14
...
INSERT INTO `servicos` (`id_servico`, `id_categoria`, `nome`, `descricao`, `detalhe`, `imagem`) VALUES
(1, 1, 'Oticas', 'Substituição da ótica danificada do seu automóvel (ótica não incluída)', 'GBQWGZDNSDBH', '2021.06.24-12.58.12.png'),
...
INSERT INTO `utilizadores` (`id_utilizador`, `utilizador`, `nome`, `passe`, `tipo_uti`) VALUES
(1, 'Ricardo', 'Ricardo', 1234, 'admin'),
(2, 'mari', 'Mari', 1234, 'normal');
